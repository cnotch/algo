...
// Test that a list l is not modified when calling InsertBefore with a mark that is not an E of l.
...
// Test that a list l is not modified when calling InsertAfter with a mark that is not an E of l.
...
// Test that a list l is not modified when calling MoveAfter or MoveBefore with a mark that is not an E of l.
