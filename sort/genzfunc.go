...
var (
	...
	inputFile  = flag.String("i", "sort.go", "input source file")
	outputFile = flag.String("o", "zfuncversion.go", "output source file")
)

func main() {
	flag.Parse()

	af, err := parser.ParseFile(fset, *inputFile, nil, 0)
	if err != nil {
		log.Fatal(err)
	}
	af.Doc = nil
	...
	out.Reset()
	out.WriteString(`// Code generated from ` + *inputFile + ` using genzfunc.go; DO NOT EDIT.
